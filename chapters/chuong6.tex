...
Phân tích định tính cho thấy mô hình có khả năng phân biệt tinh tế các ký hiệu đồng hình dựa trên biểu cảm khuôn mặt. Cụ thể, cùng một cử chỉ tay khi kết hợp với nét mặt Happy dẫn đến nhận diện "Cám ơn chân thành", trong khi nét mặt Angry dẫn đến kết quả là sắc thái tiêu cực. Điều này cho thấy 30 chiều Finger Curl kết hợp với 7 chiều Emotion đã cung cấp cho mô hình một lớp ngữ cảnh phong phú mà các hệ thống chỉ nhận dạng tay thuần túy không thể đạt được.
