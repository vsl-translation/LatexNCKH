...
\begin{itemize}
    \item \textbf{Co giãn tỷ lệ (Scale Jitter):} Nhân tọa độ bàn tay theo hệ số
    $\times$0.95 và $\times$1.05, mô phỏng người dùng đứng ở các khoảng cách
    khác nhau so với camera.

    \item \textbf{Cắt gọt thời gian (Time Warp):} Cắt 5\% và 10\% số frame ở
    đầu và cuối chuỗi, buộc mô hình học cách nhận diện ký hiệu khi được thực
    hiện ở tốc độ khác nhau.
\end{itemize}
