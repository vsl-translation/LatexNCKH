...
\begin{itemize}
    ...
    \item Xây dựng hoàn chỉnh hai luồng xử lý: Chiều VSL $\rightarrow$ VN với mô hình BiLSTM + Attention + PhoBERT, và chiều VN $\rightarrow$ VSL với NLP Pipeline sử dụng Underthesea, Sliding Window và cơ sở dữ liệu video ký hiệu.
